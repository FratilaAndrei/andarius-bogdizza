        ...
        <div className="flex w-[30%] flex-col">
          ...
          {searchItem && (
            <>
              ...
              <a
                className="mt-2 w-[30%] rounded-2xl bg-red-400 p-1 text-center text-sm font-medium text-white transition hover:scale-105 hover:bg-white hover:text-zinc-600"
                href="#"
              >
